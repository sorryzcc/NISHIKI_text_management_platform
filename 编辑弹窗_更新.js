async () => {
    ...
    if (state.key5) {
      createData.InGameKey = state.key1 + '_' + state.key2 + '_' + state.key3 + '_' + state.key4 + '_' + state.key5 + '_' + source.formData.ID + '_001';
    } else if (state.key4) {
      createData.InGameKey = state.key1 + '_' + state.key2 + '_' + state.key3 + '_' + state.key4 + '_' + source.formData.ID + '_001';
    } else {
      createData.InGameKey = state.key1 + '_' + state.key2 + '_' + state.key3 + '_' + source.formData.ID + '_001';
    }
